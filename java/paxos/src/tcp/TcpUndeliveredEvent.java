...
/**
 * Event used to signal upper layers that a connection was closed
 */
public class TcpUndeliveredEvent extends Event {
  ...
  public TcpUndeliveredEvent(Channel channel, int dir, Session session,
      Object who) throws AppiaEventException {
