...
/**
 * Timer used to monitor data activity in the TCP connections,
 * allowing the removal of unused connections.
 * 
 * @author alexp 
 */
public class TcpTimer extends PeriodicTimer {
  ...
  public TcpTimer(long period, Channel channel, Session source, int qualifier)
      throws AppiaEventException, AppiaException {
    super("TCP " + source + " TIMER", period, channel, Direction.DOWN, source,
        qualifier);
  }
}
