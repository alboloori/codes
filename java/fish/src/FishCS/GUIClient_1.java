 ...
 * @author  Arya
 */
public class GUIClient_1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        connect_Button.setText("Join and Listen");
    ...
    private void connect_ButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_connect_ButtonActionPerformed
        ...
        // Which address
        String group = "225.4.5.6";
        log_TextArea.append("[listening to: 225.4.5.6:5000]\n[...this is our group]\n");
        ...
        try {
            ...
            log_TextArea.append("[joined group]\n");
            
            // Create a DatagramPacket and do a receive
            byte buf[] = new byte [1024];
            DatagramPacket pack = new DatagramPacket(buf, buf.length);
            s.receive(pack);
            log_TextArea.append("[data received]\n");
            
            //print data we just received
            ...
            System.err.println(e);
            log_TextArea.append("[error on multicast]\n");
        }
